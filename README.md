...
recommended when the user wants a stable component (large variance)
...
*Fig. 1: The blocks (e.g., politic, agriculture, industry from Russet
...
![top\_variables.](img/top_variables.png)
